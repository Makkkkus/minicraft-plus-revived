...
public class Font {
	...
	/**
	 * Draw text on the screen without a background.
	 *
	 * @param msg    The text to write.
	 * @param screen The screen to write on.
	 * @param x      The x position of the text.
	 * @param y      The y position of the text.
	 * @see Font#draw(String, Screen, int, int, int)
	 */
	 ...
	 * @see Font#draw(String, Screen, int, int)
	 */
	public static void draw(String msg, Screen screen, int x, int y, int color) {
		...
		for (int i = 0; i < msg.length(); i++) { // Loops through all the characters that you typed
			...
			if (ix >= 0) {
				...
				screen.render(x + i * textWidth(msg.substring(i, i + 1)), y, ix + 28 * 32, 0, 3, color);
			}
		}
	}

	/**
	 * Draw a line of text on the screen with a background.
	 *
	 * @param msg    The message to write.
	 * @param screen The screen to draw on.
	 * @param x      The x position of the line.
	 * @param y      The y position of the line.
	 * @see Font#drawBackground(String, Screen, int, int, int)
	 */
	 ...
	 * @param y      The y position of the line.
	 * @param color  The color of the text.
	 * @see Font#drawBackground(String, Screen, int, int)
	 */
	public static void drawBackground(String msg, Screen screen, int x, int y, int color) {
	...
	/**
	 * Get the width of a paragraph in pixels. This is not the length of all the text, but rather the width of the longest line.
	 *
	 * @param para The paragraph of text.
	 * @return Returns the width of the longest string in para.
	 *
	 * @see Font#textWidth(String)
	 */
	...
	/**
	 * Draw a block of text with multiple lines.
	 *
	 * @param screen      The screen to write on.
	 * @param w           Width of the
	 * @param h
	 * @param style       The styling of the text.
	 * @param lineSpacing How many pixels between the lines.
	 */
	 ...
	 * Draw a block of text with multiple lines.
	 *
	 * @param lines       The lines in a list.
	 * @param screen      The screen to write on.
	 * @param style       The styling of the text.
	 * @param lineSpacing How many pixels between the lines.
	 */
	...
	/**
	 * Splits a text into a paragraph.
	 *
	 * @param para The text to be turned into a paragraph.
	 * @param w The widest the text can be in pixels.
	 * @param h The tallest the text can be in pixels.
	 * @param lineSpacing The expected spacing between the lines.
